...
const EDGE_LIST = [
  ...
  [new Person(5, "Paco"), new Person(3, "Sam"), 9],
  [new Person(5, "Paco"), new Person(10, "Alice"), 12],
  [new Person(5, "Paco"), new Person(6, "Alok"), 12],
  [new Person(7, "Dan"), new Person(19, "Boris"), 13],
  [new Person(7, "Dan"), new Person(10, "Alice"), 11],
  [new Person(7, "Dan"), new Person(5, "Paco"), 1],
  ...
  [new Person(13, "Xin"), new Person(5, "Paco"), 3],
  ...
  [new Person(17, "Andur"), new Person(5, "Paco"), 17],
